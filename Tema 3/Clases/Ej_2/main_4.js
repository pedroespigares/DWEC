...
console.log("Total carrito con descuento: " + cart.totalPriceWithDiscount());
console.log("Total carrito con productos 3x1: " +cart.totalPriceWithFreeProducts())