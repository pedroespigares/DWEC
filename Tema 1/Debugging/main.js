...
document.write(
  "They are either " + annos + " or " + annos2 + ",substituting the values"
);
...
document.write(
  "<br/>" + celsius + "º Celsius a Farenheit: " + celsiusToFarenheit
);
document.write(
  "<br/>" + farenheit + "º Farenheit a Celsius: " + farenheitToCelsius
);
...
function helloWorld(language) {
  ...
  switch (language) {
    ...
    default:
      saludo =
        "Debe especificar algún lenguaje para " + saludo + " (es, fr, de)";
  }
